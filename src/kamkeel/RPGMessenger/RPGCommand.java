...
public class RPGCommand {
    ...
    // -------------------------------------------------| Establish Command Instances
    public static CommandRole roleCMD = new CommandRole();
    public static CommandTemp tmpCMD = new CommandTemp();
    public static CommandNPC npcCMD = new CommandNPC();
    public static CommandGroup groupCMD = new CommandGroup();
    // -------------------------------------------------|
    ...
    public boolean runCMD(CommandSender sender, Command cmd, String label, final String[] args){
        if (cmd.getName().equalsIgnoreCase("role")) {
            ...
            tmpCMD.runCMD(sender, label, args);
        }
